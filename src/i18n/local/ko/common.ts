export const common = {
  ...
  hero: {
    ...
    title: 'CPET-YouCH 온라인 학습 아카데미',
    subtitle: '프로젝트 기반 학습(PBL)을 통해 협력 학습 허브를 구축하고, 학생들의 학습 동기와 비판적 사고 능력을 고취합니다.',
    partnership: {
      title: 'CPET-YouCH 온라인 아카데미',
      subtitle: '컬럼비아 대학교 교사 대학 CPET의 학술 지원',
    },
    applyNow: '지금 신청하기',
    learnMore: '자세히 보기',
    scrollDown: '아래로 스크롤',
  ...
  mission: {
    ...
    partnership: {
      badge: '평생 학술 파트너',
      title: '컬럼비아 대학교 티처스 칼리지는 우리의 평생 학술 파트너로서 커리큘럼 설계, 교사 연수, 교육 연구에 전문적 지원과 학술 지도를 제공합니다.',
    },
    achievements: '우리의 성과',
  ...
  // SEO
  seo: {
    title: '\uD504\uB85C\uC81D\uD2B8 \uAE30\uBC18 \uC628\uB77C\uC778 \uACE0\uB4F1\uD559\uAD50 | \uCEEC\uB7FC\uBE44\uC544 \uB300\uD559\uAD50 \uD2F0\uCC98\uC2A4 \uCE7C\uB9AC\uC9C0 \uC81C\uD734 | \uD559\uC0DD \uAD50\uC721 \uBC0F \uAD50\uC0AC \uC5F0\uC218',
    description: '\uCEEC\uB7FC\uBE44\uC544 \uB300\uD559\uAD50 \uD2F0\uCC98\uC2A4 \uCE7C\uB9AC\uC9C0\uC640 \uC81C\uD734\uD55C \uD0D0\uAD6C \uAE30\uBC18 \uC628\uB77C\uC778 \uACE0\uB4F1\uD559\uAD50. 7~12\uD559\uB144 \uD559\uC0DD\uC5D0\uAC8C \uC5C4\uACA9\uD55C \uC628\uB77C\uC778 \uACFC\uC815\uC744 \uC81C\uACF5\uD558\uACE0 \uD504\uB85C\uC81D\uD2B8 \uAE30\uBC18 \uD559\uC2B5(PBL)\uC744 \uD1B5\uD574 \uAD50\uC721\uC790\uC758 \uC804\uBB38 \uAC1C\uBC1C\uC744 \uC9C0\uC6D0\uD569\uB2C8\uB2E4.',
    keywords: '\uC628\uB77C\uC778 \uACE0\uB4F1\uD559\uAD50,\uD0D0\uAD6C \uAE30\uBC18 \uD559\uC2B5,\uD504\uB85C\uC81D\uD2B8 \uAE30\uBC18 \uD559\uC2B5,PBL,\uCEEC\uB7FC\uBE44\uC544 \uB300\uD559\uAD50,\uAD50\uC0AC \uC5F0\uC218,\uC628\uB77C\uC778 \uAD50\uC721,\uD559\uC220 \uACFC\uC815,\uAD50\uC0AC \uC804\uBB38 \uAC1C\uBC1C,\uAD6D\uC81C \uAD50\uC721',
    ogTitle: '\uD504\uB85C\uC81D\uD2B8 \uAE30\uBC18 \uC628\uB77C\uC778 \uACE0\uB4F1\uD559\uAD50 | \uCEEC\uB7FC\uBE44\uC544 \uB300\uD559\uAD50 \uC81C\uD734',
    ogDescription: '\uCEEC\uB7FC\uBE44\uC544 \uB300\uD559\uAD50 \uD2F0\uCC98\uC2A4 \uCE7C\uB9AC\uC9C0\uC640 \uC81C\uD734\uD558\uC5EC \uD559\uC0DD\uC5D0\uAC8C \uC591\uC9C8\uC758 \uC628\uB77C\uC778 \uAD50\uC721\uC744, \uAD50\uC0AC\uC5D0\uAC8C \uC804\uBB38\uC801 \uC131\uC7A5 \uAE30\uD68C\uB97C \uC81C\uACF5',
  },
  ...
  aboutPage: {
    hero: {
      badge: '소개',
      title: 'CPET-YouCH 온라인 아카데미를 만나보세요',
      subtitle: '컬럼비아 대학교 티처스 칼리지와 제휴하여 혁신적인 교육 방법을 통해 글로벌 시야와 비판적 사고력을 갖춘 미래 인재를 양성합니다.',
      breadcrumbLangCode: 'ko',
    },
    background: {
      badge: '아카데미 배경',
      title: '우리의 이야기',
      desc1: 'CPET-YouCH 온라인 아카데미는 컬럼비아 대학교 티처스 칼리지 교사 전문 교육 센터(CPET)와 YouCH 교육 그룹이 공동 설립하여 전 세계 학생들에게 고품질 온라인 교육 경험을 제공합니다.',
      desc2: '학술 인증을 받은 온라인 아카데미로서 전 세계 최고의 교육자들을 모아 7~12학년 학생들에게 엄격한 학술 과정을 제공하고 교육자들에게 전문 개발 교육을 제공합니다.',
      highlight1: '컬럼비아 인증',
      highlight2: '글로벌 네트워크',
      highlight3: '엄격한 기준',
      highlight4: '전문 교수진',
      timelineBadge: '발전 과정',
      timelineTitle: '우리의 성장 이야기',
      timeline: {
        m1: { year: '2018', title: '아카데미 설립', desc: 'CPET와 YouCH가 공식 제휴 협정 체결' },
        m2: { year: '2019', title: '첫 과정 개시', desc: '인문, 과학, 수학 등 핵심 과정 출시' },
        m3: { year: '2021', title: '글로벌 학습자 동맹', desc: 'GLA에 가입하여 8개국 100개 이상의 학교와 제휴' },
        m4: { year: '2023', title: '교사 연수 프로그램', desc: '교사 전문 개발 프로그램 공식 출시' },
        m5: { year: '2025', title: 'GLA 상하이 서밋', desc: '2025년 GLA 세계 서밋을 상하이에서 개최' },
      },
    },
    values: {
      badge: '핵심 가치',
      title: '우리의 핵심 가치',
      subtitle: '이러한 핵심 가치가 우리의 모든 교육 결정을 이끌고 학생들의 학습 경험을 형성합니다',
      v1: { title: '혁신적 교육', desc: '최첨단 교육 방법과 기술을 지속적으로 탐구하여 탐구 기반 학습과 프로젝트 기반 학습을 모든 과정에 통합합니다.' },
      v2: { title: '학생 중심', desc: '학생의 성장과 발전을 핵심에 두고 개인화된 학습 경로와 포괄적인 학술 지원을 제공합니다.' },
      v3: { title: '탁월함 추구', desc: '컬럼비아 대학교 티처스 칼리지와의 제휴를 통해 최고의 학술 기준을 유지합니다.' },
      v4: { title: '글로벌 시야', desc: '글로벌 학습자 동맹을 통해 전 세계 교육 자원을 연결하고 국제 이해력을 배양합니다.' },
      vision: { title: '우리의 비전', desc: '혁신적인 교육 방법과 엄격한 학술 기준을 통해 모든 학생에게 인생을 바꾸는 교육 경험을 제공하는 세계 선도적인 온라인 교육 플랫폼이 되는 것.' },
      mission: { title: '우리의 사명', desc: '컬럼비아 대학교 티처스 칼리지와의 깊은 협력을 통해 전 세계 학생들에게 고품질 탐구 기반 온라인 교육을 제공하고 교육자들에게 전문 개발 기회를 제공하는 것.' },
    },
    team: {
      badge: '우리 팀',
      title: '팀을 만나보세요',
      subtitle: '컬럼비아 대학교 티처스 칼리지와 세계 최고의 교육 기관 전문가로 구성되어 있습니다',
      leadershipTitle: '리더십 팀',
      academicTitle: '학술 및 자문 팀',
      leader1: { title: 'CPET-YOUCH 온라인 아카데미 학장', desc: 'CPET-YOUCH 미래교육연구원 이사회 멤버' },
      leader2: { title: '컬럼비아 대학교 티처스 칼리지 CPET 디렉터', desc: 'CPET-YOUCH 미래교육연구원 원장' },
      leader3: { title: 'CPET-YOUCH 미래교육연구원 집행원장', desc: 'CPET-YOUCH 글로벌 교육 혁신 프로그램 집행 감독' },
      academic1: { title: 'CPET 프로젝트 매니저' },
      academic2: { title: '학술위원회 의장' },
      academic3: { title: '학교 교사 팀 멘토' },
      academic4: { title: '학제간 PBL 전문가' },
      academic5: { title: '인문 및 리터러시 전문가' },
      academic6: { title: '수석 PD 고문' },
      stat1: '박사 학위 교수',
      stat2: '평균 교육 경험',
      stat3: '학생 대 교사 비율',
      stat4: '커버 국가',
    ...
    cta: {
      title: '학습 여정을 시작할 준비가 되셨나요?',
      subtitle: 'CPET-YouCH 온라인 아카데미에 참여하여 전 세계 교육자들과 협력 학습의 무한한 가능성을 탐구하세요',
      applyBtn: '지금 신청',
      contactBtn: '문의하기',
      newsletterLabel: '최신 교육 정보 구독',
      subscribeBtn: '구독',
    },
  },
};
